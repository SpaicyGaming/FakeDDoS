...
public class UpdateChecker{	
	...
	private static FakeDDoS main = FakeDDoS.getInstance();
	
	final static String VERSION_URL = "https://api.spiget.org/v2/resources/40583/versions?size=" + Integer.MAX_VALUE + "&spiget__ua=SpigetDocs";
	final static String DESCRIPTION_URL = "https://api.spiget.org/v2/resources/40583/updates?size=" + Integer.MAX_VALUE + "&spiget__ua=SpigetDocs";
